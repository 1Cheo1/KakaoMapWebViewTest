...
public class MainActivity extends AppCompatActivity {
    ...
    final private String DEFAULT_URL = "http://hijjuk123.dothome.co.kr/demo.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMyLocation = findViewById(R.id.button_my_location);
        mWebAppInterface = new WebAppInterface(mWebView, this);

        WebSettings webSettings = mWebView.getSettings();
        webSettings.setSaveFormData(false);
        webSettings.setJavaScriptEnabled(true);
        webSettings.setDefaultTextEncodingName("utf-8");
        mWebView.addJavascriptInterface(mWebAppInterface, "Toast");
        ...
        buttonMyLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mWebView.loadUrl("javascript:setLocateMyPosition("+position[0]+", "+position[1]+")");
